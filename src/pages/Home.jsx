...
// Skills showcase
const skills = [
  { name: 'Frontend', icon: '🎨', tech: ['React', 'JavaScript', 'HTML/CSS'], color: 'from-blue-500 to-cyan-500' },
  { name: 'Backend', icon: '⚙️', tech: ['Node.js', 'Express', 'MongoDB'], color: 'from-green-500 to-emerald-500' },
  { name: 'Mobile', icon: '📱', tech: ['Flutter', 'Dart'], color: 'from-purple-500 to-pink-500' },
  { name: 'Tools', icon: '🛠️', tech: ['Git', 'Postman', 'VS Code'], color: 'from-orange-500 to-red-500' },
]
          ...
          <AnimatedSection>
            <div className="text-center mb-12">
              <motion.h2 
                ...
                viewport={{ once: true }}
              >
                Bài Viết <span className="text-primary-light dark:text-primary-dark">Nổi Bật</span>
              </motion.h2>
              <motion.p 
              ...
              >
                Chia sẻ kiến thức về IT, công nghệ, và kinh nghiệm học tập từ góc nhìn sinh viên
              </motion.p>
            </div>
          </AnimatedSection>
                ...
                <Link to={`/blog/${post.slug}`} className="block h-full group">
                  ...
                  >
                    ...
                    <div className={`h-48 bg-gradient-to-br ${post.gradient} relative overflow-hidden`}>
                      ...
                      >
                        <span className="text-7xl z-10 drop-shadow-lg">{post.icon}</span>
                      </motion.div>
          ...
          <AnimatedSection>
            <div className="text-center mb-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                Kỹ Năng & <span className="text-primary-light dark:text-primary-dark">Công Nghệ</span>
              </h2>
            ...
            {skills.map((skill, index) => (
              ...
              >
                <div className="card h-full text-center relative overflow-hidden group">
                  ...
                  <h3 className="text-xl font-bold mb-4 relative z-10">{skill.name}</h3>
                  ...
                  <div className="flex flex-wrap gap-2 justify-center relative z-10">
                    {skill.tech.map((tech, techIndex) => (
                      <motion.span
                        ...
                        whileInView={{ opacity: 1, scale: 1 }}
                        viewport={{ once: true }}
                        transition={{ delay: 0.2 + techIndex * 0.1, type: "spring" }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Sinh Viên IT Đam Mê <span className="text-primary-light dark:text-primary-dark">Lập Trình</span>
              </h2>
              <p className="text-lg opacity-80 leading-relaxed mb-6">
                Tôi là sinh viên IT đang theo đuổi đam mê lập trình và công nghệ. 
                Với niềm yêu thích học hỏi và chia sẻ, tôi viết blog về những gì mình học được, 
                những dự án đã làm, và kinh nghiệm từ hành trình trở thành developer.
              </p>
              <p className="text-lg opacity-80 leading-relaxed mb-8">
                Blog này là nơi tôi chia sẻ kiến thức về web development, mobile development, 
                và những công nghệ mới. Hy vọng những bài viết của tôi có thể giúp ích cho các bạn sinh viên IT khác.
              </p>
            ...
            >
              {[
                { icon: FiCode, label: 'Full-Stack Development', color: 'from-blue-500 to-cyan-500' },
                { icon: FiBookOpen, label: 'Viết Blog & Chia Sẻ', color: 'from-purple-500 to-pink-500' },
                { icon: FiTarget, label: 'Học Tập Liên Tục', color: 'from-green-500 to-emerald-500' },
                { icon: FiUsers, label: 'Cộng Đồng Developer', color: 'from-orange-500 to-red-500' },
              ].map((item, index) => (
                <motion.div
                  key={item.label}
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg opacity-80 mb-8">
                  Bạn có câu hỏi về IT, lập trình, hoặc muốn trao đổi kinh nghiệm? 
                  Hãy liên hệ với tôi, tôi rất vui được trò chuyện!
                </p>
